...
On an Apple Silicon Mac, build and install the latest release from source: ``curl -fsSL https://raw.githubusercontent.com/spysystem/t3code/refs/heads/spy/main/scripts/build-spy-desktop-mac.sh | bash -s -- --install``. See the macOS section of docs/spy/README.md for prerequisites.
"@
