// This file mostly exists because we want dev mode to show the app's name instead of "electron".
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
const APP_DISPLAY_NAME = isDevelopment ? "T3 Code (SPY Dev)" : "T3 Code (SPY)";
