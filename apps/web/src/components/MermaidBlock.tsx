...
export const MermaidBlock = memo(function MermaidBlock({
  ...
  return (
    <div
      className="chat-markdown-codeblock my-[0.65rem] overflow-hidden rounded-lg border border-border/70 bg-background"
    ...
    >
      ...
      {sourceVisible || !url ? (
        ...
        <button
          ...
          className="block w-full cursor-zoom-in rounded-b-lg outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring"
          onClick={() => setExpanded(true)}
        >
          <img
            src={url}
